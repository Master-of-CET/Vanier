...
* Leonardo F.      14 April 2022    v3.0        Added WDT config.
*                                               Added comments. 
*
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
//#pragma config FWDTEN =  ON   //disable
//#pragma config WDTPS = PS512  //1:512 WDT postscaler (for MPLAB X IDE simulator)
#pragma config WDTPS = PS4096   //1:4096 WDT postscaler (for Explorer 16/32 board)
