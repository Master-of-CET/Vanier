...
NotebookDataLength[     79753,       1572]
NotebookOptionsPosition[     52771,        993]
NotebookOutlinePosition[     79018,       1554]
CellTagsIndexPosition[     78907,       1548]
...
Cell["Amplitude Modulation", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`Carrier$$ = True, $CellContext`f$$ = 
    500, $CellContext`h$$ = 50, $CellContext`SideBand$$ = 
    "lower", $CellContext`Type$$ = "dual", Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{
      Hold[
       Style["modulation", Bold]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`f$$], 500, "frequency(Hz)"}, 500, 2500, 0.01}, {{
       Hold[$CellContext`h$$], 50, "depth(%)"}, 0, 100, 0.01}, {{
       Hold[$CellContext`Carrier$$], True, "include carrier"}, {
      True, False}}, {{
       Hold[$CellContext`Type$$], "dual", "side bands"}, {
      "dual", "single"}}, {{
       Hold[$CellContext`SideBand$$], "lower", "side band"}, {
      "lower", "upper"}}}, Typeset`size$$ = {350., {198., 202.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`f$757530$$ = 0, $CellContext`h$757531$$ = 
    0, $CellContext`Carrier$757532$$ = False, $CellContext`Type$757533$$ = 
    False, $CellContext`SideBand$757534$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`Carrier$$ = True, $CellContext`f$$ = 
        500, $CellContext`h$$ = 50, $CellContext`SideBand$$ = 
        "lower", $CellContext`Type$$ = "dual"}, "ControllerVariables" :> {
        Hold[$CellContext`f$$, $CellContext`f$757530$$, 0], 
        Hold[$CellContext`h$$, $CellContext`h$757531$$, 0], 
        Hold[$CellContext`Carrier$$, $CellContext`Carrier$757532$$, False], 
        Hold[$CellContext`Type$$, $CellContext`Type$757533$$, False], 
        Hold[$CellContext`SideBand$$, $CellContext`SideBand$757534$$, False]},
       "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> GraphicsColumn[{
         Plot[{If[$CellContext`Carrier$$, 
             Sin[2 Pi $CellContext`fCar ($CellContext`t/1000)], 0] + If[
             
             Or[$CellContext`Type$$ == "dual", $CellContext`SideBand$$ == 
              "lower"], ($CellContext`h$$/200) 
             Cos[($CellContext`fCar - $CellContext`f$$) 2 
               Pi ($CellContext`t/1000)], 0] - If[
            
            Or[$CellContext`Type$$ == "dual", $CellContext`SideBand$$ == 
             "upper"], ($CellContext`h$$/200) 
            Cos[($CellContext`fCar + $CellContext`f$$) 2 
              Pi ($CellContext`t/1000)], 0], ($CellContext`h$$/100) 
           Sin[2 Pi $CellContext`f$$ ($CellContext`t/1000)]}, {$CellContext`t,
            0, 2}, PlotLabel -> Style["time domain", 16], 
          PlotRange -> {-2, 2}, 
          Ticks -> {{0, 0.5, 1, 1.5, 2}, {-1.5, -1, -0.5, 0, 0.5, 1, 1.5}}, 
          PlotStyle -> {{
             ColorData["HTML", "SlateBlue"]}, {
             RGBColor[1, 0.47, 0], Thick}}, AxesLabel -> {
            Style[
             Row[{
               Style["t", Italic], " (ms)"}], Larger]}], 
         ListPlot[{{
            If[
             
             Or[$CellContext`Type$$ == "dual", $CellContext`SideBand$$ == 
              "lower"], {$CellContext`fCar - $CellContext`f$$, \
$CellContext`h$$/2}, {$CellContext`fCar - $CellContext`f$$, 0}], 
            If[
             
             Or[$CellContext`Type$$ == "dual", $CellContext`SideBand$$ == 
              "upper"], {$CellContext`fCar + $CellContext`f$$, \
$CellContext`h$$/2}, {$CellContext`fCar + $CellContext`f$$, 0}], 
            
            If[$CellContext`Carrier$$, {$CellContext`fCar, 
              100}, {$CellContext`fCar, 
              0}]}, {{$CellContext`f$$, $CellContext`h$$}}}, 
          PlotRange -> {{0, 12650}, {-5, 105}}, Filling -> Axis, 
          FillingStyle -> {Black, Thick}, AxesOrigin -> {0, 0}, 
          Ticks -> {{0, 2500, 5000, 7500, 10000, 12500}, {0, 25, 50, 75, 
            100}}, PlotStyle -> {{
             ColorData["HTML", "SlateBlue"], 
             PointSize[Large]}, {
             RGBColor[1, 0.47, 0], 
             PointSize[Large]}}, AxesLabel -> {
            Style[
             Row[{
               Style["f", Italic], " (Hz)"}], Larger]}, PlotLabel -> 
          Style["frequency domain", 16]]}, Center, ImageSize -> {350, 400}], 
      "Specifications" :> {
        Style[
        "modulation", Bold], {{$CellContext`f$$, 500, "frequency(Hz)"}, 500, 
         2500, 0.01, Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`h$$, 50, "depth(%)"}, 0, 100, 0.01, Appearance -> 
         "Labeled", ImageSize -> Tiny}, 
        Delimiter, {{$CellContext`Carrier$$, True, "include carrier"}, {
         True, False}}, {{$CellContext`Type$$, "dual", "side bands"}, {
         "dual", "single"}, ControlType -> 
         RadioButton}, {{$CellContext`SideBand$$, "lower", "side band"}, {
         "lower", "upper"}, ControlType -> RadioButton, Enabled -> 
         Dynamic[$CellContext`Type$$ == "single"]}}, 
      "Options" :> {
       ControlPlacement -> Left, AutorunSequencing -> {1, 2, 3, 4}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{588., {226., 231.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`fCar = 10000}; Typeset`initDone$$ = True); 
     ReleaseHold[{{
         HoldComplete[$CellContext`fCar = 10000; Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`fmin = 500; Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`fmax = 2500; Null]}}]; 
...
Cell["\<\
Amplitude modulation (AM) is a technique used in electronics most commonly \
for transmitting information via radio carrier wave. The final modulation \
consists of three components: carrier, lower side band, and upper side band. \
Various combinations of these components create various types of AM with \
different properties for information transfer. Also, modulation depth has a \
big influence on modulation properties. The carrier signal with amplitude \
modulation is illustrated in blue while the modulating signal (sine wave) is \
in orange.\
\>", "ManipulateCaption"],
...
Cell[TextData[{
 ButtonBox["Amplitude Modulation",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/AmplitudeModulation.html"], 
    None}],
 " (",
...
AmplitudeModulation&version=0011"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/AmplitudeModulation/AmplitudeModulation-\
...
Cell[TextData[{
 ...
 ButtonBox["Amplitude Modulation",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/AmplitudeModulation/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/AmplitudeModulation/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/AmplitudeModulation/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/AmplitudeModulation/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/AmplitudeModulation/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41632, 725, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[41893, 734, 3169, 69, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[51949, 968, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 78621, 1537},
 {"Copyright", 78816, 1542}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34959, 592, 6080, 120, 70, "Output",
 CellID->635621517],
Cell[41042, 714, 587, 9, 70, "ManipulateCaption"],
Cell[41632, 725, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41893, 734, 3169, 69, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45065, 805, 44, 0, 70, "RelatedLinksSection"],
Cell[45112, 807, 438, 15, 70, "RelatedLinks",
 CellID->843680765],
Cell[45553, 824, 438, 15, 70, "RelatedLinks",
 CellID->408225173],
Cell[45994, 841, 4796, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[50793, 932, 45, 0, 70, "CitationSection"],
Cell[50841, 934, 778, 20, 70, "Citations"],
Cell[51622, 956, 324, 10, 70, "Author"],
Cell[51949, 968, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature 8SUtLyjdMkDRtwm6t6wJH9Ks *)
