 ...
 * File name: Remote.ino
 * 
 * Description: This is the main file for the RC remote. All inititalizing functions and tasks are called below.
 * 
 * [Version Control]*******************************************************************************************************************************
 * 
...
/**********************************************************************************************
* Name: void setup() 
* Description: Setup loop for RC remote.
*              Calls all initializing functions. 
* 
***********************************************************************************************/
void setup() {
 Serial.begin(9600);  //Serial initialization.
 Display_INIT();      //LCD display initialization.
...
***********************************************************************************************/
void loop() {
 Remote_TASK();       //Calls task constantly.
}
