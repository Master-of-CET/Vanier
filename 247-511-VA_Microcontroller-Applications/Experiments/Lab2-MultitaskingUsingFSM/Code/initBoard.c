...
* Serge Hould      6 Sept. 2021     v1.2       Disable JTAG inside initIO() .
*                                              (JTAG shared with RA5, RA4, RA1 and RA0).     
* Leonardo Fusser  2 October 2021   v1.2.1     Added config for RS232 TX pin on PIC32.                                      
* 
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
void initIO(void)
{
    ...
    TRISFbits.TRISF5 = 0;       //RS232 TX pin.
