...
* Leonardo Fusser  7 December 2021  v2.1        Added and defined SS and DC pins as outputs (for
*                                               SPI slave).         
*
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
void initIOs(void){
    ...
    TRISGbits.TRISG9 = 0;      //SS pin for PMOD OLED display.
    TRISBbits.TRISB15 = 0;     //DC pin for PMOD OLED display.
}
#elif defined MX3
void initIOs(void){
    /* LEDs */
